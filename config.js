var config = (function () {
    ...
    const CREEPS = [
        ...
        {role: ROLE_BUILDER, num: 1, parts: [WORK, CARRY, MOVE], priorityGeneration: 2},
        {role: ROLE_UPGRADER, num: 1, parts: [WORK, CARRY, MOVE], priorityGeneration: 3},
        {role: ROLE_BUILDER, num: 1, parts: [WORK, CARRY, MOVE], priorityGeneration: 4}
    ];
